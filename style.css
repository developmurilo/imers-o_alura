...
.item-resultado img {
    ...
    margin-top: 10px;
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.3); /* Adiciona uma sombra leve */
    transition: all 0.3s ease-in-out; /* Aplique a transição a todas as propriedades para suavizar a animação */
  }
